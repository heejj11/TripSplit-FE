    ...
    <div className="w-full max-w-sm sm:max-w-md">
      <div className="bg-white rounded-2xl shadow-sm border p-6 sm:p-8">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">회원가입</h1>
          <p className="text-sm text-gray-500 mt-2">TripSplit과 함께 여행을 시작하세요</p>
        </div>
        ...
        <div className="space-y-3 mb-6">
          ...
          >
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
              <path fillRule="evenodd" clipRule="evenodd" d="M9 0C4.02943 0 0 3.13403 0 7.00268C0 9.41904 1.5584 11.5436 3.93152 12.7862L2.93303 16.4834C2.84481 16.8014 3.21085 17.0548 3.48909 16.8713L7.87267 13.9049C8.2453 13.9492 8.62294 13.972 9.00369 13.972C13.9706 13.972 18 10.8527 18 7.00268C18 3.13403 13.9706 0 9 0Z" fill="#191919"/>
            </svg>
            카카오로 시작하기
          </button>
          <button
