    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="bg-white rounded-xl border p-4 sm:p-6 mb-4">
        <div className="flex items-center gap-3 sm:gap-4">
          <div
            className={`w-14 h-14 sm:w-16 sm:h-16 ${user.profileColor} rounded-full flex items-center justify-center text-white text-xl sm:text-2xl font-bold flex-shrink-0`}
          >
            {user.nickname[0]}
          </div>
      ...
      {/* 버전 */}
      <p className="text-center text-xs text-gray-400 mt-6">TripSplit v1.0.0</p>
    </div>
  );
}
